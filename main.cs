...
public class PairSumCounter
{
    ...
    public static void Main()
    {
        int[] arr1 = { 3, 4, 5, 6 };
        int X1 = 1;
        Console.WriteLine(CountPairsWithSum(arr1, X1));  // Output: 0

        int[] arr2 = { 0, 15, 32, 2000, 15000 };
        int X2 = 15;
        Console.WriteLine(CountPairsWithSum(arr2, X2));  // Output: 1

        int[] arr3 = { 1, 1, 10, 32, 41 };
        int X3 = 42;
        Console.WriteLine(CountPairsWithSum(arr3, X3));  // Output: 2
    }
}
